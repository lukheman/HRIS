    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="@base_url(#)">{{ $role }}</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <!--   <div class="row"> -->
          <!--     <div class="col-lg-6"> -->
          <!--       <a class="btn btn-primary float-end" href="@base_url(/hrd/karyawanAddForm)">Tambah Karyawan</a> -->
          <!--     </div> -->
          <!--   </div> -->
          <!-- </div> -->
                  ...
                  <table id="" class="table table-bordered table-striped dataTable dtr-inline collapsed"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <form action="/keuangan/gajiKaryawan/verifikasi" method="post">
