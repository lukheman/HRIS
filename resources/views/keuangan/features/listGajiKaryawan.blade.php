      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-header">
            ...
            <div class="row">
              <div class="col-lg-6">
                <form action="/keuangan/gaji-karyawan" method="get">
              ...
              <div class="col-lg-6">
                <a class="btn btn-primary" href="/keuangan/gaji-karyawan/update?periode={{ $periode}}">Refresh
                  Data</a>
                <a class="btn btn-outline-primary float-right"
                  href="/keuangan/gaji-karyawan/cetak-slip-gaji-all?periode={{$periode}}">
                  ...
                  <table id="" class="table table-bordered table-striped dataTable dtr-inline collapsed"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <form action="/keuangan/gaji-karyawan/cetak-slip-gaji" method="post">
