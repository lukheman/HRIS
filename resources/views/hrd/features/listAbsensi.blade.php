          ...
          <div class="card-header">
            <div class="row">
              <div class="col-12">
                ...
                <div class="btn-group">
                  <a href="/hrd/absensi/all?by=day" class="btn btn-primary {{ $by === 'day' ? 'disabled' : 'active' }}">
                    <i class="nav-icon fas fa-calendar-day"></i>
                    Hari Ini</a>
                  <a class="btn btn-primary {{ $by === 'month' ? 'disabled' : 'active' }}"
                    href="/hrd/absensi/all?by=month"> <i class="nav-icon fas fa-calendar-week"></i>
                    Bulan Ini</a>
                </div>
                  ...
                  <table id="datatable" class="table table-bordered table-striped dataTable dtr-inline collapsed"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <form action="/hrd/absensi/detail" method="get">
